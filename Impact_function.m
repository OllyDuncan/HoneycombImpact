function [out,Buckle,Densif,Completed,Absorbed,Off2M] = Impact_function(EIn,SHeight,SWidth,SDepth,Ess,col,h0,t,theta0,Offset,run,maxrun)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Absorbed=Dd2-nn;
Off2M=max(Off2);
% %% Figures commented out to save run time
% figure(1)
